...
For the  etcd-key (For Client Key)
...
For the  etcd-cert (For Client Certification)
...
For the  etcd-ca cert (For root certification)
...
> Replacing etcd endpoint with your enpoint ip address.
